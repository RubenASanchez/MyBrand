...
function activateNavigation() {
    $('.timeline nav a').on('click',function(e){
        ...
        $('.panelslider').animate({left:newPosition+'px'}, 1000);
        
        var backgroundWidth = $('.timeline .backgroundslider img').width();
        ...
        $('.backgroundslider img.background').animate({left:newBackgroundPosition+'px'},1000);
        e.preventDefault();
    });
}
